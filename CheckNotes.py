...
class SampleApp(tk.Tk):
    def __init__(self):
        ...
        self.unitsFrame = tk.LabelFrame(page1,borderwidth=1,relief="groove",text="UNDER UNITS",font=Font(family='Arial Bold', size=11))
        self.unitsFrame.pack(padx=20, pady=10,anchor="w",fill=tk.X)
        self.var5 = tk.IntVar()
        self.var5.set(1)
        ...
        self.overlapFrame = tk.LabelFrame(page1,borderwidth=1,relief="groove",text="OVERLAPPING / DUPLICATE TIMES",font=Font(family='Arial Bold', size=11))
        self.overlapFrame.pack(padx=20, pady=10,anchor="w",fill=tk.X)
        self.var6 = tk.IntVar()
        self.var6.set(1)
        self.checkboxoverlap = tk.Checkbutton(self.overlapFrame, text="Enable", variable=self.var6).grid(row=7,column=0)
